...
function IconLeaf() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M21 3a16 16 0 0 0-16 16 4 4 0 0 0 4-4A16 16 0 0 0 21 3z" />
      <path d="M9 15 21 3" />
    </svg>
  )
}
...
function IconGoogle() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24">
      <path fill="#EA4335" d="M12 10.2v3.9h5.5c-.24 1.4-1.7 4.1-5.5 4.1-3.3 0-6-2.7-6-6.2s2.7-6.2 6-6.2c1.9 0 3.1.8 3.9 1.5l2.7-2.6C16.9 3.1 14.7 2 12 2 6.9 2 2.7 6.2 2.7 11.5S6.9 21 12 21c6.9 0 8.9-4.8 8.9-7.3 0-.5-.05-.9-.13-1.3H12z" />
    </svg>
  )
}
...
function Header() {
  ...
  const navLinks = [
    ...
    { label: 'Technologie', href: '#moderna', icon: <IconLeaf /> },
        ...
        <nav style={{ display: 'flex', gap: '8px', flex: 1 }} className="hidden-mobile">
          {navLinks.map(l => (
            <a
              ...
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = '#EFEDE6'; (e.currentTarget as HTMLElement).style.background = 'rgba(255,255,255,0.06)' }}
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = 'rgba(239,237,230,0.75)'; (e.currentTarget as HTMLElement).style.background = 'transparent' }}
            >
              {l.icon ? <span style={{ color: '#3E8A6B' }}>{l.icon}</span> : null}
              {l.label}
            </a>
          ))}
        </nav>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '64px 80px', alignItems: 'center' }}>
          ...
          <div>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '16px', lineHeight: 1.7, color: 'rgba(239,237,230,0.78)', marginBottom: '32px' }}>
              Jsme dva instalatéři a spolupracujeme více než 15 let. V oboru se pohybujeme téměř 20 let. Zabýváme se montáží veškerých technologií v oblasti instalatérství. Srdcem naší práce je precizní provedení a vysoká úroveň zpracování zaručující spokojenost zákazníků. Každý zákazník je pro nás jedinečný a proto se snažíme každý projekt přizpůsobit individuálním potřebám. Sledujeme aktuální technologické trendy a snažíme se implementovat moderní a energeticky úsporná řešení do naší práce. Působíme na Jižní Moravě.
            </p>
...
const services = [
  {
    ...
    accent: 'copper',
    photos: ['https://images.unsplash.com/photo-1639600993675-2281b2c939f0?w=600&h=500&fit=crop&auto=format'],
  },
  {
    icon: <IconFilter />,
    title: 'Úpravny vody',
    desc: 'Návrh a montáž úpraven a filtrace vody pro čistou a kvalitní vodu v domácnosti i firmě.',
    accent: 'teal',
    photos: [] as string[],
  },
  {
  ...
  },
  {
    ...
    accent: 'teal',
    photos: ['https://images.unsplash.com/photo-1660330589257-813305a4a383?w=600&h=500&fit=crop&auto=format'],
  },
  {
    icon: <IconRadiator />,
  ...
  },
  {
    ...
    desc: 'Proplachy topných systémů, chemická úprava topné vody a drobné zednické a izolatérské práce v souvislosti s instalacemi.',
    accent: 'copper',
    photos: ['https://images.unsplash.com/photo-1620653713380-7a34b773fef8?w=600&h=500&fit=crop&auto=format'],
  },
]
    ...
    <section id="sluzby" style={{ backgroundColor: '#F4F3EC', padding: '120px 24px' }}>
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        <div style={{ textAlign: 'center', marginBottom: '64px' }}>
          ...
          <p style={{ fontFamily: 'var(--font-body)', fontSize: '15px', color: '#5a6875', margin: 0 }}>
            Klikněte na službu a prohlédněte si ukázky z naší realizace.
          </p>
        </div>
          ...
          {services.map((s, i) => {
            ...
            return (
              ...
              >
                ...
                <p style={{ fontFamily: 'var(--font-body)', fontSize: '14px', lineHeight: 1.6, color: '#5a6875', margin: '0 0 14px' }}>{s.desc}</p>
                <span style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '13px', color: accentColor }}>
                  Zobrazit realizace <IconArrowRight />
                </span>
              </button>
            )
          })}
        ...
        >
          ...
          >
            <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '16px', marginBottom: '20px' }}>
              <h3 style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '22px', color: '#1C242B', margin: 0 }}>{active.title}</h3>
              <button
                onClick={() => setOpenIdx(null)}
                aria-label="Zavřít"
            ...
            {active.photos.length > 0 ? (
              ...
              <p style={{ fontFamily: 'var(--font-body)', fontSize: '15px', color: '#5a6875', margin: 0, lineHeight: 1.6 }}>
                Fotky z realizací této služby brzy doplníme.
              </p>
            )}
          </div>
        </div>
...
function Partners() {
  return (
    <section style={{ backgroundColor: '#F4F3EC', padding: '0 24px 100px' }}>
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', position: 'relative' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '64px 80px', alignItems: 'center' }}>
          ...
          <div>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '16px', lineHeight: 1.7, color: 'rgba(239,237,230,0.78)', marginBottom: '32px' }}>
              Rozvody plynu, plynové přípojky a solární systémy pro ohřev vody jsou nedílnou součástí moderního vytápění. Jsme specializováni na moderní, energeticky úsporná řešení, která snižují vaše náklady na provoz dlouhodobě. Sami si zajišťujeme projekty s výpočtem tepelných ztrát, využíváme kombinace více tepelných zdrojů, zpracováváme projekty rozvodů plynu včetně revizních zpráv a zajišťujeme vložkování komínů včetně revizních zpráv.
            </p>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', marginBottom: '40px' }}>
              {[
                ...
                'Kompletní návrh řešení pro úsporu energie',
              ].map((item, i) => (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px', alignItems: 'center' }}>
          ...
          <div
            style={{
              ...
              aspectRatio: '3/2', border: '1px solid rgba(201,122,62,0.2)',
            }}
          >
            <iframe
              title="Mapa — Jihomoravský kraj"
              src="https://www.google.com/maps?q=Jihomoravsk%C3%BD+kraj&output=embed"
      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '64px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '40px' }}>
            ...
            {/* Reviews */}
            <div style={{ borderLeft: '3px solid rgba(201,122,62,0.3)', paddingLeft: '24px' }}>
              <p style={{ fontFamily: 'var(--font-body)', fontSize: '13px', fontWeight: 600, color: 'rgba(239,237,230,0.5)', textTransform: 'uppercase', letterSpacing: '0.06em', margin: '0 0 12px' }}>
                Reference
              </p>
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px' }}>
                <a
                  href="https://www.google.com/maps/search/?api=1&query=Veselý+%26+Šebesta+instalatérství+Pohořelice"
                  target="_blank" rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#EFEDE6', textDecoration: 'none', fontFamily: 'var(--font-body)', fontSize: '14px', border: '1px solid rgba(239,237,230,0.2)', borderRadius: '7px', padding: '9px 16px' }}
                >
                  <IconGoogle /> Recenze na Googlu
                </a>
                <a
                  href="https://www.firmy.cz/?q=Veselý+a+Šebesta+Pohořelice"
                  target="_blank" rel="noopener noreferrer"
                  style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#EFEDE6', textDecoration: 'none', fontFamily: 'var(--font-body)', fontSize: '14px', border: '1px solid rgba(239,237,230,0.2)', borderRadius: '7px', padding: '9px 16px' }}
                >
                  <span style={{ color: '#C97A3E' }}><IconStar /></span> Recenze na Seznamu
                </a>
              </div>
            </div>
          </div>
